...
type TasksClient interface {
	...
	// 添加任务完毕
	SendCompleted(ctx context.Context, in *TaskProject, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
...
func (c *tasksClient) SendCompleted(ctx context.Context, in *TaskProject, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
...
type TasksServer interface {
	...
	// 添加任务完毕
	SendCompleted(context.Context, *TaskProject) (*google_protobuf.Empty, error)
